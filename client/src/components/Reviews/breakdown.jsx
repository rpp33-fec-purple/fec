  ...
  render() {
    ...
    if (this.props.reviews.results && this.props.meta.ratings) {
      ...
      <>
        ...
        <>{ratingFilterView}</>
        <Wrapper>
          <RatingBarContainer><ActionDiv value={5} onClick={this.handleRatingClick} style={{fontSize: "10px"}}>5 stars<span>({ratings[5]})</span></ActionDiv><RatingBar value={5} onClick={this.handleRatingClick}><RatingBarFill style={{width: `${(ratings[5] / numOfRatings) * 100}%`}}></RatingBarFill></RatingBar></RatingBarContainer>
          <RatingBarContainer><ActionDiv value={4} onClick={this.handleRatingClick} style={{fontSize: "10px"}}>4 stars<span>({ratings[4]})</span></ActionDiv><RatingBar value={4} onClick={this.handleRatingClick}><RatingBarFill style={{width: `${(ratings[4] / numOfRatings) * 100}%`}}></RatingBarFill></RatingBar></RatingBarContainer>
          <RatingBarContainer><ActionDiv value={3} onClick={this.handleRatingClick} style={{fontSize: "10px"}}>3 stars<span>({ratings[3]})</span></ActionDiv><RatingBar value={3} onClick={this.handleRatingClick}><RatingBarFill style={{width: `${(ratings[3] / numOfRatings) * 100}%`}}></RatingBarFill></RatingBar></RatingBarContainer>
          <RatingBarContainer><ActionDiv value={2} onClick={this.handleRatingClick} style={{fontSize: "10px"}}>2 stars<span>({ratings[2]})</span></ActionDiv><RatingBar value={2} onClick={this.handleRatingClick}><RatingBarFill style={{width: `${(ratings[2] / numOfRatings) * 100}%`}}></RatingBarFill></RatingBar></RatingBarContainer>
          <RatingBarContainer><ActionDiv value={1} onClick={this.handleRatingClick} style={{fontSize: "10px"}}>1 stars<span>({ratings[1]})</span></ActionDiv><RatingBar value={1} onClick={this.handleRatingClick}><RatingBarFill style={{width: `${(ratings[1] / numOfRatings) * 100}%`}}></RatingBarFill></RatingBar></RatingBarContainer>
        </Wrapper>
